...
$pageCss = '/AD-Bookstore/page/cart/assets/css/cart.css';
...
<section class="shopping-cart">
    ...
    <?php if (empty($cart)): ?>
        <p>Your cart is empty. <a href="/AD-Bookstore/page/home/index.php">Start shopping!</a></p>
    <?php else: ?>
        <div class="cart-items">
            ...
            ?>
                    <div class="cart-item">
                        ...
                        <form action="/AD-Bookstore/handlers/book_operations.handler.php" method="post" class="remove-form">
